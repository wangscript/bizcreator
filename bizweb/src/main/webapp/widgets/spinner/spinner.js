YUI.add('slider', function(Y) {
	...
	/*
	 * The attribute configuration for the Spinner widget. Attribute can be
	...
	Y.extend(Spinner, Widget, {
		 ...
		 * the Widget class. It is invoked during contrustruction,
		 * and can be used to setup instance specific state.
		 * 
		 * The Spinner class does need to perform anything
		 * specific in this method, but it is left in as an example.
		 */
		initializer: function() {
			// Not doing anthing special during initialization
		},
		 ...
		 * to attribute value change, and also attach any DOM events, 
		 * to activate the UI.
		 * 
		 ...
		 * - Binds a simple change listeners on the input box.
		 */
		bindUI : function() {
        ...
        /*
         * Create the input control for the spinner and adds it to 
