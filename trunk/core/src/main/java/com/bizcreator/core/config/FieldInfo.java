...
public class FieldInfo extends PropertyInfo {
    ...
    public void injectProperty(Object object, ObjectFactoryImpl objectFactory) {
        ...
        try {
            ...
            throw new BaseException("couldn't set field '" + propertyName + "' on class '" + object.getClass() + "' to value '" + propertyValue + "'", e);
        }
    }
    ...
    Field findField(Class clazz) {
        ...
        if (field == null) {
            BaseException e = new BaseException("couldn't find field '" + propertyName + "' in class '" + clazz.getName() + "'");
            log.error( "", e);
            throw e;
        }
