...
/**
 * Convenient super class for iBATIS SqlSession data access objects.
 * Requires a SqlSession to be set, providing a SqlSessionTemplate
 * based on it to subclasses.
 *
 * <p>Instead of a plain SqlSession, you can also pass a preconfigured
 * SqlSessionTemplate instance in. This allows you to share your
 * SqlSessionTemplate configuration for all your DAOs, for example
